...
Route::get('/post/create', 'PostsController@create')->name('create');//shows the create post screen
Route::get('/post/{id}', 'PostsController@show')->name('post.show');      //shows specific post
Route::get('/post/{id}/edit', 'PostsController@edit')->name('edit'); //shows the edit post screen
